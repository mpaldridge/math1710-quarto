...
This module is **MATH1710 Probability and Statistics I**. (It is possible to take this module as half of **MATH2700 Probability and Statistics for Scientists**, but I am not aware that any students are enrolled on MATH2700 this year -- please [let me know](mailto:m.aldridge@leeds.ac.uk) if you are.)
...
All lectures are in [Roger Stevens LT 20](https://students.leeds.ac.uk/rooms?type=room&id=100044). Check your timetable to see which group you are in.
...
You can read more about the language R, and about the program RStudio that we recommend you use to interact with R, in [the R section of these notes](#R).
...
### Optional "office hours" drop-in sessions {.unnumbered #dropin}
...
* Thursdays from 1400 to 1500 in [Roger Stevens LT 7](https://students.leeds.ac.uk/rooms?type=room&id=100031)
* Thursdays from 1600 to 1700 in [Roger Stevens LT 17](https://students.leeds.ac.uk/rooms?type=room&id=100041)

Although only the second of these appears on your timetable, you are equally welcome at either. Depending on attendance levels, I may change arrangements as term continues. If neither time is possible, you may [email me](mailto:m.aldridge@leeds.ac.uk) to book a time to talk to me.
...
* *I have an admin question about general arrangements for my programme as a whole:* [Contact the Student Information Service](https://students.leeds.ac.uk/askingforhelp) or speak to your personal academic tutor.
