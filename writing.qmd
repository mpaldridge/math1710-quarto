...
```{r writing-pic-0, engine = 'tikz', echo=FALSE, fig.align="center", out.width="320pt", cache = TRUE}
...
```{r writing-pic-1, engine = 'tikz', echo=FALSE, fig.align="center", out.width="320pt", cache = TRUE}
\begin{tikzpicture}[line width=0.25pt, scale=0.8]
